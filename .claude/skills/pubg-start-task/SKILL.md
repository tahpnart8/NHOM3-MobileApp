...
2. **Read what it names.** The feature row in `docs/product/features.md` and every document the issue lists. Read `docs/data/*` if the issue touches Firestore or Room. Read `memory/code/README.md` and the `memory/code/` file for the area you will code in. Do not read more than you need.
