...
no "too long"                 subject_ok "feat: aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa"
ok "vietnamese subject"       subject_ok "feat(auth): thêm nút đăng nhập bằng Google"
ok "long vietnamese subject"  subject_ok "fix(offline): sửa lỗi mất dữ liệu đã lưu khi xoay màn hình"
no "vietnamese too long"      subject_ok "feat(listing): thêm màn hình đăng tin bán đồ cũ có chọn nhiều ảnh và xem trước trước khi đăng"
no "capital vietnamese start" subject_ok "feat: Thêm nút đăng nhập"
...
no "vietnamese byline"        check_message "feat: x

Được tạo bởi Claude Code"
no "vietnamese written with"  check_message "feat: x

Viết bằng Gemini"
ok "vietnamese mention of a tool" check_message "docs(agents): giải thích cài đặt claude code"
...
# ---- Vietnamese text ----------------------------------------------------------------------------
ok "vietnamese title"         vi_text_ok "thêm nút đăng nhập bằng Google" 1
no "english title"            vi_text_ok "add google sign-in button" 1
ok "vietnamese body"          vi_text_ok "Thêm nút đăng nhập bằng Google vào màn hình đăng nhập." 12
no "english body"             vi_text_ok "Adds the button and the Firebase credential exchange. Closes #12" 12
no "symbols do not count"     vi_text_ok "→ → → → → → → → → → → → → … … … …" 12
ok "decomposed vietnamese"    vi_text_ok "$(printf 'eÌ')" 1
no "an empty text"            vi_text_ok "" 1
